...
def main():
    ...
    file_format = st.sidebar.radio("Type of Format",("Single columns","Multi columns"))
    st.sidebar.header("Users guides:")
    st.sidebar.markdown('1. Choose format for images\n  2. Drag and drop your images\n 3. Check box for csv format\n 4. Press "Run Model"\n  5. Download your files',unsafe_allow_html=True)
